#! /bin/sh
PUMA_CONFIG_FILE=/var/www/earthquakes/current/config/puma.rb
PUMA_PID_FILE=/var/www/earthquakes/current/tmp/pids/puma.pid
PUMA_SOCKET=/var/www/earthquakes/current/tmp/sockets/puma.sock
